...
GetSaloonDetails()
  ...
  $.ajax({
            ...
            data: JSON.stringify({
              ...
              url: " http://15.206.129.105:8080/MerchandiseAPI/Appointments/GetAllSaloonDetails",
            ...
            success: function (data, textStatus, jqXHR) {
              ...
              console.log("SALOON DETAILS :",data);
                              ...
                              $.each(data.saloonDetails, function (i, item) {
                                ...
                                saloonArray.push({ label: item.companyName, value: item.companyId });
...
BackbtnFunc() {
  ...
  MakeAppointmentFunc(){
    ...
    console.log("MAKE APPOINTMENT DATA :",JSON.stringify({
      ...
      const label_style={
        paddingTop: "20px"
          ...
          return (
            <div class="container">
              ...
              <div class="card">
                <div class="card-header" style={{ backgroundColor: "" }}>
                  <h4 style={{ fontWeight: "300", fontSize: "30px" }}>Make Appointment - Customer</h4>
                </div>
              </div>
            ...
            <div class="row" style={{ backgroundColor: "" }}>
              <div class="col-xs-12 col-sm-4 col-lg-4 " style={label_style}>
                <label class="control-label selectpicker" for="customerName"> Saloons:</label>
                <Select
                  id="selectedOption"
                  name="selectedOption"
                  isMulti={false}

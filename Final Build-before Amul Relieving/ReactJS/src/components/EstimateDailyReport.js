...
class EstimateDailyReport extends Component {
  ...
  componentDidMount() {
    ...
    $.ajax({
      ...
      url: " http://15.206.129.105:8080/MerchandiseAPI/EstimateReport/DailyEstimateReport",
        ...
        if (data.length != 0) {
          ...
          $.each(data, function (i, item) {
            ...
            tab += '<tbody id= "myTable" ><tr   id="tabletextcol" ><td>' + no + '</td>'
              ...
              + '<td>' + item.status + '</td><td>' + item.subtotal1 + '</td><td>' + item.balanceAmt + '</td>'
              + '</tr></tbody>';
          ...
          self.state.data[Number(ivalue) + 1] = {
            ...
            "Contact": "",
            "Status": "",
            "Total": <div style={{ fontWeight: "600" }}>{"TotalAmount"}</div>,
      ...
      <div class="container" style={{ height: "20px" }}>
        ...
        <div class="row">
          ...
          <div class="col-sm-4 ">
                  ...
                  <h4  id="reportHeader" style={{marginLeft:"130px"}}>Estimate Daily Report</h4>
  ...
  <h4 id="reportheader" style={{marginLeft:"130px"}}>Estimate Daily Report</h4>   <hr></hr>
          </div>

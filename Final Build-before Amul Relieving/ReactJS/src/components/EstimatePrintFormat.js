        ...
        ReactDOM.render(
            <Router>
                <div>
                    ...
                    <Route path="/" component={EstimateReportDisplay} />
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                $.each(data, function (i, item) {
                    ...
                    if (item.product != null) {
                        ...
                        tab += '<tr><td style="padding: 0px 10px; font-size:9px;vertical-align: top;line-height:15px;text-align:center;">'+no+'</td><td style=" padding: 0px 10px;font-size:9px;vertical-align:top;line-height:15px;text-align:left;">' + item.product + '</td><td style="padding: 0px 10px; font-size:9px;vertical-align: top;line-height:15px;text-align:left;">' + item.rate + '</td><td style="padding: 0px 10px; font-size:9px;vertical-align: top;line-height:15px;text-align:left;">' + item.qty + '</td><td style="padding: 0px 10px; font-size:9px;vertical-align: top;line-height:15px;text-align:left;">' + item.total + '</td></tr>';
                     
                        self.state.totalAmount = Math.round(Number(self.state.totalAmount)) + Math.round(Number(item.total));
                        ...
                        self.state.advance = item.advance;
                         ...
                         self.state.balanceAmount =item.balanceAmount;
                         ...
                         self.setState({
                            ...
                            balanceAmount: self.state.balanceAmount,
                                    ...
                                    <table cellspacing="0" cellpadding="0" class="branding " width="100%" style={{ borderLeft: "1px solid", borderRight: " 1px solid", borderTop: "1px solid", borderColor: "#0070C0" }} >
                                        ...
                                        <tbody><tr>
                                            <td style={{ position: "relative", verticalAlign: "top" }}>
                                                <img id="Image1" src={r1} style={{ height: "12%", padding: "0.1%", margin: "0", padding: "3px", border: "0", fontSize: "100%", font: "inherit", verticalAlign: "baseline" }} />
                                        ...
                                        <tr>
                                            <td class="main-border" style={{ width: "700px", borderBottom: "none", border: "1px solid #0070C0", padding: "0", margin: "0" }}>
                                                <table cellspacing="0" border="0" cellpadding="0" class="header">
                                                    <tbody><tr>
                                                        <td style={{ width: "100%", verticalAlign: "middle", borderBottom: "1px solid #0070C0" }} class="header-row">
                                                            <table cellspacing="0" cellpadding="0">
                                                                <tbody><tr>
                                                ...
                                                <table><tbody><tr>
                                                    <td style={{ borderBottom: "1px solid #0070C0" }}>
                                                        <table cellspacing="0" class="customerdata " style={{ tableLayout: "fixed" }}><tbody><tr>
                                                            <td colspan="2" style={{ textAlign: "middle", fontWeight: "bold", borderRight: "1px solid #0070C0", borderBottom: "1px solid #0070C0", width: "100%", textAlign: "center", padding: "2px 5px 3px 5px", fontSize: "11px", verticalAlign: "top", lineHeight: "13px" }}>Customer Detail</td></tr>
                                                            <tr>
                                                                <td style={{ fontWeight: "bold", padding: "2px 5px 3px 5px", fontSize: "11px", verticalAlign: "top", lineHeight: "13px" }}>M/S</td>
                                                        ...
                                                        <table cellspacing="0" class="invoicedata ">
                                                            <tbody><tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style={{ padding: "3px 5px 6px 5px", fontSize: "11px", verticalAlign: " top", lineHeight: "13px" }} colspan="3"><span id="ContentPlaceHolder1_lbl_balance"></span></td>
                                                                </tr>
                                                                <tr>
                                ...
                                <div class="page-content" style={{ height: "250px", position: "relative",marginTop:"-11px" }}>
                                    <table class="tableboxLinetable" style={{ border: "1px solid #0070C0", width: "100%", position: "absolute", top: "0", left: "0" }} cellspacing="0" cellpadding="0" border="0">
                                        ...
                                        <tbody style={{ height: " 100%" }}><tr>
                                            <td class="tableboxLine linebox1" style={{ width: "2.4%", left: " 0px", height: " 250px", borderRight: "1px  solid #0070C0", borderLeft: "1px  solid #0070C0", borderCollapse: "collapse", top: "0", boxSizing: "borderBox", mozBoxSizing: "borderBox", webkitBoxSizing: "borderBox" }}></td>
                                            <td class="tableboxLine linebox2" style={{ width: "15%", left: " 3%", height: "250px", borderRight: "1px  solid #0070C0", borderLeft: "1px  solid #0070C0", borderCollapse: "collapse", top: "0", boxSizing: "borderBox", mozBoxSizing: "borderBox", webkitBoxSizing: "borderBox" }}></td>
                                            <td class="tableboxLine linebox5" style={{ width: "6%", left: "42%", height: "250px", borderRight: "1px  solid #0070C0", borderLeft: "1px  solid #0070C0", borderCollapse: "collapse", top: "0", boxSizing: "borderBox", mozBoxSizing: "borderBox", webkitBoxSizing: "borderBox" }}></td>
                                            <td class="tableboxLine linebox6" style={{ width: "7%", left: "50%", height: "250px", borderRight: "1px  solid #0070C0", borderLeft: "1px  solid #0070C0", borderCollapse: "collapse", top: "0", boxSizing: "borderBox", mozBoxSizing: "borderBox", webkitBoxSizing: "borderBox" }}></td>
                                            <td class="tableboxLine linebox7" style={{ width: "8%", left: "57%", height: "250px", borderRight: "1px  solid #0070C0", borderLeft: "1px  solid #0070C0", borderCollapse: "collapse", top: "0", boxSizing: "borderBox", mozBoxSizing: "borderBox", webkitBoxSizing: "borderBox" }}></td>
                                            </tr></tbody>
                                        </table>
                                ...
                                <div class="page-footer">
                                    ...
                                    <table class="invoicedataFooter" cellspacing="0" style={{ width: "100%" }}>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td class="txt-bold txt-right" style={{ textAlign: "right", fontSize: "10px", backgroundColor: "#E8F3FD", padding: "5px 1px 5px 0px", border: "1px solid #0070C0" }}><span id="lbl_total_taxable">{this.state.totalQty}</span></td>
                                            <td class="txt-bold txt-right" style={{ textAlign: "right", fontSize: "10px", backgroundColor: "#E8F3FD", padding: "5px 1px 5px 0px", border: "1px solid #0070C0" }}><span id="lbl_sub_total">{this.state.totalAmount}</span></td>
                                        </tr>
                                        </tbody></table>
                                                    ...
                                                    <tbody><tr>
                                                        <td style={{ borderTop: "none", borderRight: "none", borderLeft: "none", verticalAlign: "top" }}>
                                                            ...
                                                            <table cellspacing="0" style={{ width: "100%", borderCollapse: "collapse" }} class="invoiceInfo">
                                                                <tbody><tr>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2" style={{ width: "100%", textAlign: "center", borderBottom: "none", padding: "3px 5px", fontSize: "11px", lineHeight: "13px", fontWeight: "bold", border: "1px solid #0070C0", borderLeft: "none", borderRight: "none" }}>Terms and Conditions</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="2" style={{ width: "100%", borderBottom: "none", padding: "3px 5px", fontSize: "11px", lineHeight: "13px", fontWeight: "bold", border: "1px solid #0070C0", borderLeft: "none", borderRight: "none" }}>
                                                                            ...
                                                                            <div style={{ height: "90px", width: "100%", overflow: "hidden", fontWeight: "bold", fontSize: "10px", borderBottom: "none" }}>1. Subject to our home Jurisdiction.<br />2. Our Responsibility Ceases as soon as goods leaves our Premises.<br />3. Goods once sold will not taken back.<br />4. Delivery Ex-Premises.</div></td>
                                                                    </tr>
                                                                </tbody></table>
                                                        </td>
                                                        <td style={{ borderTop: "none", verticalAlign: "top" }}>
                                                            <table cellspacing="0" style={{ width: "100%", borderCollapse: "collapse" }} class="invoiceTotal">
                                                                ...
                                                                <tbody><tr>
                                                                    <td class="txt-bg" style={{ padding: "8px 5px", fontSize: "10px", lineHeight: "13px", fontWeight: "bold", border: "1px solid #0070C0", borderRight: "none", backgroundColor: "#E8F3FD" }}>Total </td>
                                                                    <td class="txt-bg txt-right" style={{ padding: "3px 5px", fontSize: "10px", lineHeight: "13px", fontWeight: "bold", border: "1px solid #0070C0", borderRight: "none", backgroundColor: "#E8F3FD" }}><span id="lbl_total_taxable2">{this.state.subtotal1}</span></td>
                                                                </tr>
                                                 

                                                                    <tr>
                                                                        <td class="txt-bg" style={{ padding: "6px 5px", fontSize: "10px", lineHeight: "13px", fontWeight: "bold", border: "1px solid #0070C0", borderRight: "none", backgroundColor: "#E8F3FD" }}>Advance</td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="txt-bg" style={{ padding: "6px 5px", fontSize: "10px", lineHeight: "13px", fontWeight: "bold", border: "1px solid #0070C0", borderRight: "none", backgroundColor: "#E8F3FD" }}>Discount</td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="txt-bg" style={{ padding: "5px 5px", fontSize: "10px", lineHeight: "13px", fontWeight: "bold", border: "1px solid #0070C0", borderRight: "none", backgroundColor: "#E8F3FD" }}><b>Balance</b></td>
                                                                        <td class="txt-bg txt-right" style={{ padding: "3px 5px", fontSize: "14px", lineHeight: "13px", fontWeight: "bold", border: "1px solid #0070C0", borderRight: "none", backgroundColor: "#E8F3FD" }}><span id="lbl_grand_total">{this.state.balanceAmount}</span></td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td colspan="2" style={{ borderBottom: "none", textAlign: "center", fontSize: "8px", padding: "6px 5px", lineHeight: "13px", fontWeight: "bold", border: "1px solid #0070C0", borderRight: "none" }}>Certified that the particulars given above are true and correct.</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="2" style={{ borderTop: "none", borderBottom: "none", textAlign: "center", fontSize: "12px", padding: "5px 5px", lineHeight: "13px", fontWeight: "bold", border: "1px solid #0070C0", borderRight: "none" }}>For, <span id="lbl_company_name2">{this.state.companyName}</span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="2" style={{ borderBottom: "none", height: "60px", textAlign: "center", padding: "50px 5px", fontSize: "14px", lineHeight: "13px", fontWeight: "bold", border: "1px solid #0070C0", borderRight: "none" }}>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="2" style={{ borderBottom: "none", textAlign: "center", fontSize: "8px", padding: "8px 5px", lineHeight: "13px", fontWeight: "bold", border: "1px solid #0070C0", borderRight: "none" }}>Authorised Sign</td>
                                                                    </tr>
                                                                </tbody></table>
                                                        </td>
                                                    </tr>

...
import ChatBotCommunication from "../ChatBotCommunication";
...
export default class GenericDashboardElite extends Component {
 constructor() {
 super()
 ...
 Chatbotcommunication() {
  ReactDOM.render(
    <Router>
      <div>
        <Route path="/" component={ChatBotCommunication} />
      </div>
    </Router>,
    document.getElementById('contentRender'));
...
ChatbotDetails() {
    ...
    ReactDOM.render(
      <Router>
        <div>
          <Route path="/" component={ChatBotDetails} />
        </div>
      </Router>,
      document.getElementById('contentRender'));
...
*/
 ...
 ConfigFunc() {
   ...
   if (item.permission == "AddEstimatetoInvoices") {
   flag = 0;//true
   }
   });
 ...
 RewardFunc(){
   ...
   if (item.permission == "RewardsProgram") {
   flag = 0;//true
   }
   });
 ...
 Appointment(){
   var PermissionHeader = JSON.parse(
    ...
    var i = PermissionHeader.length;
    $.each(PermissionHeader, function (i, item) {
      if (item.permissionHeader == "appointment") {
        flag = 0; //true
      }
    });
 ...
 if (flag == 0) {
   ...
   AppointmentCalendarFunc(){
      ...
      if (item.permission == "appointmentCalendar") {
      flag = 0;//true
      }
      });
 ...
 */} 
 {/* <li><a className="sidemenu_autoclose" onClick={() => this.Chatbotcommunication()}><i class="fa fa-angle-right fa_submenu" style={{ border: "none", display: "inline-block", fontSize: "15px" }} aria-hidden="true"></i><span className="sbar_smenu_font"> Chat Bot Communction</span></a></li>
<li><a className="sidemenu_autoclose" onClick={() => this.ChatbotDetails()}><i class="fa fa-angle-right fa_submenu" style={{ border: "none", display: "inline-block", fontSize: "15px" }} aria-hidden="true"></i><span className="sbar_smenu_font"> Chat Bot Details</span></a></li>
  */}
...
<li>
 ...
 <li>
 <a className="sidemenu_autoclose" onClick={() => this.TaskmappingElite()}><i class="fa fa-superpowers i_sidebar" style={{ border: "none", display: "inline-block" ,paddingRight: "14px"}} aria-hidden="true"></i><span id="spantask" className="sidebar_Title"> Task Mapping</span></a>

...
var days1;
var  currentRow;
class SalesYearlyReportMonthYear extends Component {
  constructor(props) {
    super(props)
    var today = new Date();
...
//	 alert("plantype"+planName);
 ...
 registerServiceWorker();
  ...
  <ul class="previous disabled" id="backbutton"
     ...
     <h4 className="centerAlign " style={{ textAlign: "center" }}>Sales Report  <span className="centerAlign hideContent"> for {this.state.monthName} {this.state.dispyear}</span> </h4>
...
export default SalesYearlyReportMonthYear;
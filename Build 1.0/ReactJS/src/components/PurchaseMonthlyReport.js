...
class PurchaseMonthlyReport extends Component {
 ...
 $("#reportheader").hide();
        ...
        $.ajax({
            ...
            url: " http://15.206.129.105:8080/MerchandiseAPI/PurchaseReport/MonthlyPurchaseReport",
...
BackbtnFunc() {
 ...
 <div class="card">
                <div class="row">
                  ...
                  <h4  id="reportHeader" style={{marginLeft:"130px"}}>Purchase Monthly Report</h4>
  ...
  <h4 id="reportheader" style={{marginLeft:"130px"}}>Purchase Monthly Report</h4>      <hr></hr>
                    </div>

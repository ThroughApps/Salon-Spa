...
import ExpDateWiseReportDisplay from './ExpDateWiseReportDisplay';
...
class ExpDateWiseReport extends Component {
    ...
    $.ajax({
       ...
       url: " http://15.206.129.105:8080/MerchandiseAPI/ExpenseReport/DateWiseExpenseReport",
                ...
                <Router>
                  <div>
                   {/* <Route path="/" component={EmployeeMenuHeader} /> */}
                    ...
                    <Route path="/" component={() => <ExpDateWiseReportDisplay data={data} />} />
...
export default ExpDateWiseReport;
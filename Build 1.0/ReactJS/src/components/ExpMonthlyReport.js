...
class ExpMonthlyReport extends Component {
 ...
 $("#reportheader").hide();
    ...
    $.ajax({
      ...
      url: " http://15.206.129.105:8080/MerchandiseAPI/ExpenseReport/MonthlyExpenseReport",
      ...
      success: function (data, textStatus, jqXHR) {
        ...
        if (data.length != 0) {
          ...
          $.each(data.dailyExpenseList, function (i, item) {
            no = parseInt(i) + 1;
          ...
          $.each(data.summaryExpenseList, function (i, item) {
            no = parseInt(i) + 1;
  ...
  GetColumns() {
    return Object.keys(this.state.data[1]).map(key => {
...
//	 alert("plantype"+planName);
 ...
 $("#sidebar").show();
    ...
    return (
      ...
      <div class="container" style={{ height: "20px" }}>
        ...
        <div class="row">
                  ...
                  <h4  id="reportHeader" style={{marginLeft:"130px"}}>Expense Monthly Report</h4>
  ...
  <h4 id="reportheader" style={{marginLeft:"130px"}}>Expense Monthly Report</h4>       <hr></hr>
          </div>

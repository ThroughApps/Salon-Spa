...
var days1;
var currentRow;
class EstimateYearlyReportMonthYear extends Component {
  constructor(props) {
    super(props)
    var today = new Date();
  ...
  render() {
    ...
    return (
      <div className="container" style={{ paddingTop: "0px", paddingBottom: "10px" }}>
        ...
        <h4 className="centerAlign " style={{ textAlign: "center" }}>Estimate Report  <span className="centerAlign hideContent">  {this.state.monthName} {this.state.dispyear}</span> </h4>
...
export default EstimateYearlyReportMonthYear;
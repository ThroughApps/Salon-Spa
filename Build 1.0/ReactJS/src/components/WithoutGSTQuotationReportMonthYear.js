...
var days1;
var  currentRow;
class WithoutGSTQuotationReportMonthYear extends Component {
  constructor(props) {
    super(props)
    var today = new Date();
  ...
  Submit() {
    ...
    self.state.data=[];
      ...
      url: " http://15.206.129.105:8080/MerchandiseAPI/quotation/withoutgstquotationreportmonthyear",
...
//	 alert("plantype"+planName);
 ...
 registerServiceWorker();
  ...
  <ul class="previous disabled" id="backbutton"
     ...
     <h4 className="centerAlign " style={{ textAlign: "center" }}>WithoutGSTQuotation Report  <span className="centerAlign hideContent"> for {this.state.monthName} {this.state.dispyear}</span> </h4>
...
table="tableHeadings"
filename="WithoutGSTQuotation_List"
sheet="tablexls"
buttonText="Download" />
            </div>
          </div>
...
export default WithoutGSTQuotationReportMonthYear;
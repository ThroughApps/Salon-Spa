...
class WithoutGSTQuotation1 extends Component {
  constructor(data) {
    super(data)
    var today = new Date();
...
role:role,  
 ...
 validateField1(fieldName, value) {
  ...
  CancelFunc() {
    ReactDOM.render(<WithoutGSTQuotation1 />, document.getElementById("contentRender"));
...
*/
  ...
  WithoutGSTQuotationFunc() {
    ...
    $("#tablecontents tr").each(function () {
      ...
      var productId=currentRow.find("td:eq(5)").text(); 
      if(description==""){
        description='-';
      }    
...
role: self.state.role,
            ...
            url: " http://15.206.129.105:8080/MerchandiseAPI/quotation/addwithoutgstquotationorder",
            ...
            success: function (data, textStatus, jqXHR) {
                    ...
                    Swal.fire({
                      position: 'center',
                      icon: 'success',
                      title: 'Quotation [' + data.invoiceNo + '] for amount Rs.' + self.state.finalAmountTotal + '  is Generated.',               // Message dialog  
                      showConfirmButton: false,
                      timer: 2000
                    })
  ...
  AddToCart() {
    ...
    if ((this.state.productName !=0)) {
      ...
      var tab = '<tr style={{backgroundColor: "white",fontColor:"black",fontWeight:"bold"}} id="tabletextcol" ><td>' + self.state.productName + '</td><td>' + self.state.rate + '</td><td>' + self.state.quantity + '</td><td>' + self.state.total + '</td><td  class="heightWidth" >' + self.state.description + '</td><td  class="heightWidth" >' + self.state.productId + '</td><td><button id="delete">Delete</button></td></tr>';
      ...
      <div class="container">
        ...
        <div class="card">
          <div class="card-header" style={{ backgroundColor: "white" }}>
            <h4 style={{ fontWeight: "300", color: "black", fontSize: "30px" }}>WithoutGST Quotation</h4>
            <hr></hr>
          </div>
          <div>
            <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        <tbody>
                          ...
                          <tr><th></th>
                            <td>
                              <button type="button" id="estimateInvoice" onClick={() => this.WithoutGSTQuotationFunc()} style={{ marginRight: "5px" }} class="btn btn-primary pull-right">Save Quotation</button> <span></span>
                            </td>
                            <td>
                              <button type="button" onClick={() => this.cancelFunc()} style={{ marginRight: "5px" }} class="btn btn-primary pull-right">Cancel</button> <span></span>
                            </td>
...
export default WithoutGSTQuotation1;
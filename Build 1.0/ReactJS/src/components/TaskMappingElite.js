 ...
 var role = CryptoJS.AES.decrypt(localStorage.getItem('Role'), "shinchanbaby").toString(CryptoJS.enc.Utf8)
      ...
      success: function (data, textStatus, jqXHR) {
        ...
        if (data.headerPermissionList.length != 0) {
          if (data.headerPermissionList[0].permission != "") {
            console.log("headerPermissionList",data.headerPermissionList);
            $.each(data.headerPermissionList, function (i, item) {
              console.log("headerPermissionList"+item.permission);
  ...
  handleCheckBoxMaster = e => {
    ...
    if ($("#" + name).is(":checked")) {
      ...
      console.log("check", this.state.permission);
    ...
    //"uncheck"
      ...
      console.log("uncheck", iHeader, i);
      while (i--) {
        if (name == this.state.permission[i]) {
          this.state.permission.splice(i, 1);
          console.log("3s splice i trackVehicle", this.state.permission);
        }
      }
      ...
      if (
        ...
        while (iHeader--) {
          if ("master" == this.state.permissionHeader[iHeader]) {
            ...
            console.log("4s splice i header", this.state.permissionHeader);
          }
        }
        $("#master").prop("checked", false);
      } else {
        console.log("no change in header");
      }
    }
  };
  ...
  handleCheckBoxQuotation = e => {
    ...
    //"uncheck"
      ...
      while (i--) {
        if (name == this.state.permission[i]) {
          this.state.permission.splice(i, 1);
          console.log("3s splice i quotation", this.state.permission);
        }
      }
      //checking all submenu is checked or not becz to remove haeder
      if (
  ...
  handleCheckBoxBank = e => {
    ...
    //"uncheck"
      ...
      while (i--) {
        if (name == this.state.permission[i]) {
          this.state.permission.splice(i, 1);
          console.log("3s splice i bank", this.state.permission);
        }
      }
      //checking all submenu is checked or not becz to remove haeder
      if (
  ...
  handleCheckBoxFileGST = e => {
    ...
    //"uncheck"
      ...
      while (i--) {
        if (name == this.state.permission[i]) {
          this.state.permission.splice(i, 1);
          console.log("3s splice i fileGST", this.state.permission);
        }
      }
      //checking all submenu is checked or not becz to remove haeder
      if (
  ...
  handleCheckBoxAppointment = e => {
    ...
    if ($("#" + name).is(":checked")) {
      ...
      if ($("#appointment").is(":checked")) {
        ...
        this.state.permissionHeader.push("appointment");
        console.log("change");
      }
    }
    //"uncheck"
      ...
      while (i--) {
        if (name == this.state.permission[i]) {
          this.state.permission.splice(i, 1);
          console.log("3s splice i appointment", this.state.permission);
        }
      }
      //checking all submenu is checked or not becz to remove haeder
      if (
        !$("#appointmentCalendar").is(":checked") 
      ) {
        var iHeader = this.state.permissionHeader.length;
        while (iHeader--) {
          if ("appointment" == this.state.permissionHeader[iHeader]) {
            this.state.permissionHeader.splice(iHeader, 1);
            console.log("4s splice i header", this.state.permissionHeader);
          }
        }
  ...
  handleCheckBoxReports = e => {
    ...
    //"uncheck"
      ...
      while (i--) {
        if (name == this.state.permission[i]) {
          this.state.permission.splice(i, 1);
          console.log("3s splice i Report", this.state.permission);
        }
      }
      //checking all submenu is checked or not becz to remove haeder
  ...
  handleCheckBoxConfiguration = e => {
    ...
    if ($("#" + name).is(":checked")) {
      ...
      if ($("#configuration").is(":checked")) {
        ...
        this.state.permissionHeader.push("configuration");
        console.log("change");
      }
    }
    //"uncheck"
      ...
      while (i--) {
        if (name == this.state.permission[i]) {
          this.state.permission.splice(i, 1);
          console.log("3s splice i configuration", this.state.permission);
        }
      }
      //checking all submenu is checked or not becz to remove haeder
      if (
        ...
        !$("#emails").is(":checked") &&
        !$("#AddEstimatetoInvoices").is(":checked")&&
        !$("#RewardsProgram").is(":checked")
      ) {
        var iHeader = this.state.permissionHeader.length;
        while (iHeader--) {
  ...
  handleCheckBoxAttendance = e => {
    ...
    //"uncheck"
      ...
      while (i--) {
        if (name == this.state.permission[i]) {
          this.state.permission.splice(i, 1);
          console.log("3s splice i attendance", this.state.permission);
        }
      }
      
      //checking all submenu is checked or not becz to remove haeder
      if (
        !$("#CheckInCheckOut").is(":checked") &&
            ...
            if ($("#" + name).is(":checked")) {
              ...
              while (i--) {
                if ("addCustomer" == this.state.permission[i]) {
                  ...
                  console.log("4 splice i addCustomer", this.state.permission);
                }
                if ("listOfCustomer" == this.state.permission[i]) {
                  this.state.permission.splice(i, 1);
                  console.log("4 splice i listOfCustomer ", this.state.permission);
                }
                if ("addVendor" == this.state.permission[i]) {
                  this.state.permission.splice(i, 1);

                  console.log("4 splice i addVendor", this.state.permission);
                }
                if ("listOfVendor" == this.state.permission[i]) {
                  this.state.permission.splice(i, 1);
                  console.log("4 splice i listOfVendor ", this.state.permission);
                }
                if ("addProduct" == this.state.permission[i]) {
                  this.state.permission.splice(i, 1);

                  console.log("4 splice i addProduct", this.state.permission);
                }
                if ("listOfProduct" == this.state.permission[i]) {
                  this.state.permission.splice(i, 1);
                  console.log("4 splice i listOfProduct ", this.state.permission);
                }
              }
              while (iHeader--) {
                if ("master" == this.state.permissionHeader[iHeader]) {
            ...
            if ($("#" + name).is(":checked")) {
              ...
              while (i--) {
                if ("saleOrder" == this.state.permission[i]) {
                  ...
                  console.log("4 splice i saleOrder", this.state.permission);
                }
                if ("saleInvoice" == this.state.permission[i]) {
                  this.state.permission.splice(i, 1);

                  console.log("4 splice i saleInvoice ", this.state.permission);
                }
                if ("estimateOrder" == this.state.permission[i]) {
                  this.state.permission.splice(i, 1);

                  console.log("4 splice i estimateOrder", this.state.permission);
                }
                if ("estimateInvoice" == this.state.permission[i]) {
                  this.state.permission.splice(i, 1);

                  console.log("4 splice i estimateInvoice ", this.state.permission);
                }
            ...
            if ($("#" + name).is(":checked")) {
              ...
              while (i--) {
                if ("purchaseOrder" == this.state.permission[i]) {
                  ...
                  console.log("4 splice i purchaseOrder", this.state.permission);
                }
                if ("purchaseInvoice" == this.state.permission[i]) {
                  this.state.permission.splice(i, 1);

                  console.log("4 splice i purchaseInvoice ", this.state.permission);
                }
              }
              while (iHeader--) {
                if ("purchase" == this.state.permissionHeader[iHeader]) {
              ...
              if ($("#" + name).is(":checked")) {
                ...
                while (i--) {
                  ...
                  if ("withoutGSTQuotation" == this.state.permission[i]) {
                    ...
                    console.log(
                      "4 splice i withoutGSTQuotation ",
                      this.state.permission
                    );
                  }
      ...
      case "bank":
        {
          ...
          if (name == "bank") {
            /*  alert("2"); */
            console.log("mairgyumaintenancegyug", name, "staus", $("#" + name).is(":checked"));
      ...
      case "reports":
        {
          ...
          if (name == "reports") {
            ...
            if ($("#" + name).is(":checked")) {
              ...
              $("#profitLossReport").prop("checked", true);
              $("#inventoryReport").prop("checked", true);
              $("#appointmentReport").prop("checked", true);
              $("#expenseReport").prop("checked", true);
             
              this.state.permissionHeader.push(name);
              this.state.permission.push(
                "salesReport", "estimateReport", "purchaseReport",
                "quotationReport", "messageCenterReport",
                "profitLossReport", "inventoryReport",
                "appointmentReport","expenseReport"
              );
              ...
              $("#profitLossReport").prop("checked", false);
              $("#inventoryReport").prop("checked", false);
              $("#expenseReport").prop("checked", false);
              $("#appointmentReport").prop("checked", false);
              ...
              while (i--) {
                switch (this.state.permission[i]) {
                  ...
                  case "quotationReport":
                    ...
                    break;
                  case "messageCenterReport":

                    this.state.permission.splice(i, 1);

                    console.log("4 splice i messageCenterReport ", this.state.permission);
                    break;
                  case "profitLossReport":
                    this.state.permission.splice(i, 1);
                    console.log("4 splice i profitLossReport", this.state.permission);
                    break;

                  case "inventoryReport":
                    this.state.permission.splice(i, 1);
                    console.log("4 splice i inventoryReport", this.state.permission);
                    break;
                  case "appointmentReport":
                    this.state.permission.splice(i, 1);
                    console.log("4 splice i appointmentReport ", this.state.permission);
                    break;
                    case "expenseReport":
                      this.state.permission.splice(i, 1);
      ...
      case "configuration":
        {
          ...
          if (name == "configuration") {
            ...
            if ($("#" + name).is(":checked")) {
              ...
              $("#AddEstimatetoInvoices").prop("checked", true);
              $("#RewardsProgram").prop("checked", true);
              this.state.permissionHeader.push(name);
              this.state.permission.push(
                "OfferMessages",
                "emails",
                "AddEstimatetoInvoices",
                "RewardsProgram",
              );
              ...
              $("#AddEstimatetoInvoices").prop("checked", false);
              $("#RewardsProgram").prop("checked", false);
              var i = this.state.permission.length;
              var iHeader = this.state.permissionHeader.length;
              ...
              while (i--) {
                ...
                if ("AddEstimatetoInvoices" == this.state.permission[i]) {
                  this.state.permission.splice(i, 1);

                  console.log("4 splice i AddEstimatetoInvoices ", this.state.permission);
                }
                if ("RewardsProgram" == this.state.permission[i]) {
                  this.state.permission.splice(i, 1);

                  console.log("4 splice i RewardsProgram ", this.state.permission);
                }
              }
              while (iHeader--) {
                if ("configuration" == this.state.permissionHeader[iHeader]) {
        ...
        case "appointment":
        {
            ...
            if ($("#" + name).is(":checked")) {
              /*  alert("3"); */
              //sub menu checked
              $("#appointmentCalendar").prop("checked", true);
              ...
              /*  alert("4"); */
              $("#appointmentCalendar").prop("checked", false);
              ...
              console.log("4.1", iHeader, i);
              while (i--) {
                if ("appointmentCalendar" == this.state.permission[i]) {
                  this.state.permission.splice(i, 1);
                }
        ...
        case "attendance":
        {
            ...
            if ($("#" + name).is(":checked")) {
              ...
              //sub menu checked
              $("#CheckInCheckOut").prop("checked", true);
              ...
              $("#CheckInCheckOut").prop("checked", false);
              ...
              console.log("4.1", iHeader, i);
              while (i--) {
                if ("CheckInCheckOut" == this.state.permission[i]) {
                  this.state.permission.splice(i, 1);
              ...
              console.log("After while break", this.state.permissionHeader);
    ...
    $(document).ready(function () {
      $(".CheckBoxClass").click(function () {
        if ($("#ckbCheckAll").is(":checked")) {
          console.log("True");
          self.state.permissionHeader.push("master,sale,purchase,expense,quotation,bank,taskMapping,fileGST,configuration,reports,attendance,employee,appointment");
          self.state.permission.push(
            ...
            +"profitLossReport,profitLossReport,inventoryReport,appointmentReport,OfferMessages,emails,AddEstimatetoInvoices,RewardsProgram,appointmentCalendar,"
            +"CheckInCheckOut,manualAttendance,report,addEmployee,listOfEmployee,addRole");

          console.log("permission ", self.state.permission);
          console.log("permission Header ", self.state.permissionHeader);
        } else {
          self.state.permission = [];
          self.state.permissionHeader = [];
  ...
  Submit() {
    ...
    $.ajax({
      ...
      async: false,
      success: function (data, textStatus, jqXHR) {
        console.log("TASK-MAPPING DATA :", data);
                ...
                <div style={{ paddingLeft: "45px" }}>
                  <div class="checkbox ">
                    <label>
                      <input
                        ...
                        name="OfferMessages"
                        onChange={this.handleCheckBoxConfiguration}
                        id="OfferMessages"
                        class="checkBoxClass"
                      />
                     Offer Messages
                  ...
                  <div class="checkbox ">
                    <label>
                      <input
                        type="checkbox"
                        value={this.state.AddEstimatetoInvoices}
                        name="AddEstimatetoInvoices"
                        onChange={this.handleCheckBoxConfiguration}
                        id="AddEstimatetoInvoices"
                        class="checkBoxClass"
                      />
                     Add Estimate to Invoices
                    </label>
                  </div>
                  <div class="checkbox ">
                    <label>
                      <input
                        type="checkbox"
                        value={this.state.RewardsProgram}
                        name="RewardsProgram"
                        onChange={this.handleCheckBoxConfiguration}
                        id="RewardsProgram"
                        class="checkBoxClass"
                  ...
                  <div class="checkbox ">
                    <label>
                      <input
                        ...
                        onChange={this.handleCheckBoxAppointment}
                ...
                <div style={{ paddingLeft: "45px" }}>
                  <div class="checkbox ">
                    <label>
                      <input
                        type="checkbox"
                        value={this.state.CheckInCheckOut}
              ...
              <div style={{ paddingLeft: "45px" }}>
                ...
                <div class="checkbox ">
                  <label>
                    <input
                      type="checkbox"
                      value={this.state.profitLossReport}
                ...
                <div class="checkbox ">
                  <label>
                    <input
                      ...
                      class="checkBoxClass reportClass"
                    />
                   Inventory Report(Available Stock,Stock Summary Report)
                  </label>
                </div>
                <div class="checkbox ">
                  <label>
                    <input
                      type="checkbox"
                      value={this.state.appointmentReport}
                      name="appointmentReport"
                      onChange={this.handleCheckBoxReports}
                      id="appointmentReport"
                      class="checkBoxClass reportClass"
                    />
                   Appointment Reports(Appointments History,Future Appointments Report)
                  </label>
                </div>

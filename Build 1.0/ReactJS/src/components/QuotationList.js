...
import GSTQuotation1 from './GSTQuotation';


var currentRow;
class QuotationList1 extends Component {
  constructor(data) {
    super(data)
...
role:role, 
    ...
    $.ajax({
      ...
      success: function (data, textStatus, jqXHR) {
        ...
        if (data.gstquotationreportlist.length != 0) {
          var tab = '<thead><tr class="headcolor"><th>S.No</th><th>Invoice</th><th>date</th><th>Name</th><th>Contact</th><th>Address</th><th>GST</th><th>Total(Rs)</th></tr></thead>';
        ...
        if (column.Header === "Delete") {
          ...
          if (rowInfo != undefined) {
            ...
            ReactDOM.render(
              <Router>
                <div>
                  <Route path="/" component={() => <GSTQuotationReportDisplay
                    userName={this.state.userName}
  ...
  NoAction() {
    ReactDOM.render(
      <Router>
        <div>
          <Route path="/" component={QuotationList1} />
        </div>
      </Router>,
      document.getElementById('contentRender'));
            ...
            <div style={{ display: "grid" }}>
              <div className="row">
                ...
                <div className="col-sm-4 col-lg-2 col-md-2">
                  <a class="pageredirectbtn" href="#" onClick={() => this.AddGSTQuotationPageFunc()}>
                    <span style={{ fontWeight: "700", fontWeight: "900", fontSize: "15px" }}>+ GSTQuotation</span>
                  </a>
                </div>
                <div className="col-sm-4 col-lg-2 col-md-2">

...
class TaskMappingPremium extends Component {
  constructor() {
    super();
          ...
          if (name == "reports") {
            ...
            if ($("#" + name).is(":checked")) {
              ...
              this.state.permission.push(
                ...
                "profitLossReport","expenseReport"
              );
    ...
    $(document).ready(function () {
      $(".CheckBoxClass").click(function () {
        if ($("#ckbCheckAll").is(":checked")) {
          console.log("True");
          self.state.permissionHeader.push("master,sale,purchase,expense,quotation,bank,taskMapping,fileGST,configuration,reports,employee");
          self.state.permission.push(
            "addCustomer,listOfCustomer,addVendor,listOfVendor,addProduct,listOfProduct,saleOrder,saleInvoice,estimateOrder,"
            ...
            +"profitLossReport,profitLossReport,OfferMessages,emails,AddEstimatetoInvoices,RewardsProgram,addEmployee,listOfEmployee,addRole");
...
export default TaskMappingPremium;

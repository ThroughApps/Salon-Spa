...
class PurchaseYearlyReportMonthYear extends Component {
  ...
  Submit() {
    ...
    $.ajax({
       ...
       url: " http://15.206.129.105:8080/MerchandiseAPI/PurchaseReport/YearlyPurchaseReport",
...
//	 alert("plantype"+planName);
 ...
 registerServiceWorker();
  ...
  <ul class="previous disabled" id="backbutton"
     ...
     <h4 className="centerAlign " style={{ textAlign: "center" }}>Purchase Report  <span className="centerAlign hideContent"> for {this.state.monthName} {this.state.dispyear}</span> </h4>
